...
3. **Rule Enforcement:** Ensure Data Transfer Objects (DTOs) from Ktor remain isolated in the data layer. Ensure Room database operations run on `Dispatchers.IO`.